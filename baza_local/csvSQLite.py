...
# -------------------------------------------------------
CSV_PATH = "D:\\FOI\\3. godina\\ZAVRSNI\\DriveBeat\\zavrsni_test_local.csv"  # putanja do Exportify CSV-a
DB_PATH = "D:\\FOI\\3. godina\\ZAVRSNI\\DriveBeat\\glazba.db"                # gdje će se kreirati SQLite baza
# -------------------------------------------------------
