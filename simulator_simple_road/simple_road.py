...
BASE_DIR=os.path.dirname(os.path.abspath(__file__)) #modifikacija od originalnog koda - dodano da se nađe putanja
...
def main():
    ...
    #images
    light_road=pygame.image.load(os.path.join(BASE_DIR,'light_road.png')).convert() #modifikacija od originalnog koda - dodano da se nađe putanja
    dark_road=pygame.image.load(os.path.join(BASE_DIR,'dark_road.png')).convert() #modifikacija od originalnog koda - dodano da se nađe putanja
    #variables
